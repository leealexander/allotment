...
namespace EpeverReader.Accessors
{
    public class StatusAccesssor
    {
        ...
        public static async Task<Status> AccessAsync(byte slaveId, IModbusSerialMaster master)
        {
            ...
            return new Status
            {
                SolarPanel = ConvertRawValue("SolarPanel", _arrayTaxonomy, data, 0),
                Charge = ConvertRawValue("Charge", _chargeTaxonomy, data, 1),
                Battery = ConvertRawValue("Battery", _batteryStatusTaxonomy, data, 2),
                Load = ConvertRawValue("Load", _loadStatusTaxonomy, data, 3),
                Controller = ConvertRawValue("Controller", _controllerStatusTaxonomy, data, 4),
            };
        }
